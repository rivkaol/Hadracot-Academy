...
export default function TrialWelcomeScreen({ tutorial, onStart }) {
  return (
    <div className="flex-1 flex flex-col items-center justify-center p-4 bg-[#FAF7F2] pb-10 text-center">
      <div className="w-full max-w-lg">
        ...
        <p className="text-lg font-bold text-[#9E626C] mb-6">זה הצעד הראשון שלך.</p>
        <p className="text-[#716861] mb-8">אל תנסי לראות הכול. מתחילים מכאן.</p>
